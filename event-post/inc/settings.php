...
class Settings{
	...
	public function register_settings(){
		...
		add_settings_field(
				...
				'eventpost-settings',
				'eventpost-settings-timeline',
				array( 'name' => 'container_shema', 'description'=>__('default:','event-post').' <code>'.htmlentities(EventPost()->default_timeline_shema['container']).'</code>')
		);
		add_settings_field(
				'timeline_item_shema',
				...
				'eventpost-settings',
				'eventpost-settings-timeline',
				array( 'name' => 'item_shema', 'description'=>__('default:','event-post').' <code>'.htmlentities(EventPost()->default_timeline_shema['item']).'</code>')
		);
		// Appearance
		add_settings_section(
